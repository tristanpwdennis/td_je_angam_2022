...
pkg = c("tidyverse", "rnaturalearth", "rnaturalearthdata", "sf", "cowplot", "scatterpie", "parallel", "gridExtra", "grid", "data.table")
...
#ac_fig = egg::ggarrange(ac_df_mh, ac_rf_mh, ac_cs_mh, ncol = 1, nrow = 3, labels=c('A', 'B', 'C'))
ggsave(plot=ag_fig,filename = '~/OneDrive - University of Glasgow/MOVE/manuscripts/td_je_angam_2022/figures/fig4_angam_fst.tiff', device = grDevices::tiff, width = 20, height = 6.6, units = 'cm')
```
