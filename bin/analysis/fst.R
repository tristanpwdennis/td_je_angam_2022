...
plot(x=fstlist[[31]]$chr, y=fstlist[[31]]$Nsites,type='l', ylim=c(0,0.5), axes = F, ann=FALSE, col='#8dd3c7') #2L
plot(x=fstlist[[32]]$chr, y=fstlist[[32]]$Nsites,type='l', ylim=c(0,0.5), axes = F, ann=FALSE, col = '#8dd3c7') #2R
plot(x=fstlist[[33]]$chr, y=fstlist[[33]]$Nsites,type='l', ylim=c(0,0.5), axes = F, ann=FALSE, col='#8dd3c7') #3L
plot(x=fstlist[[34]]$chr, y=fstlist[[34]]$Nsites,type='l', ylim=c(0,0.5), axes = F, ann=FALSE, col='#8dd3c7') #3R
plot(x=fstlist[[35]]$chr, y=fstlist[[35]]$Nsites,type='l', ylim=c(0,0.5), axes = F, ann=FALSE, col='#8dd3c7') #X
#s_savannah_decid_forest
plot(x=fstlist[[36]]$chr, y=fstlist[[36]]$Nsites,type='l', ylim=c(0,0.5), axes = F, ann=FALSE, col='#feeea6') #2L) #2L
plot(x=fstlist[[37]]$chr, y=fstlist[[37]]$Nsites,type='l', ylim=c(0,0.5), axes = F, ann=FALSE, col = '#feeea6') #2R) #2R
plot(x=fstlist[[38]]$chr, y=fstlist[[38]]$Nsites,type='l', ylim=c(0,0.5), axes = F, ann=FALSE, col='#feeea6') #3L) #3L
plot(x=fstlist[[39]]$chr, y=fstlist[[39]]$Nsites,type='l', ylim=c(0,0.5), axes = F, ann=FALSE, col='#feeea6') #3R) #3R
plot(x=fstlist[[40]]$chr, y=fstlist[[40]]$Nsites,type='l', ylim=c(0,0.5), axes = F, ann=FALSE, col='#feeea6') #XSE) #X
#s_savannah_rainforest
plot(x=fstlist[[41]]$chr, y=fstlist[[41]]$Nsites,type='l', ylim=c(0,0.5), axes = F, ann=FALSE, col='#80b1d3') #2L) #2L
plot(x=fstlist[[42]]$chr, y=fstlist[[42]]$Nsites,type='l', ylim=c(0,0.5), axes = F, ann=FALSE, col = '#80b1d3') #2R) #2R
